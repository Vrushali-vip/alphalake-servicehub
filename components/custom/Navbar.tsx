            ...
            <div className="flex-grow">
                <div className="flex align-center">
                    ...
                    <div className="absolute sidebar-panel right-0 top-0 pt-2 lg:pt-1 bg-card lg:bg-transparent min-h-screen lg:min-h-0 lg:px-3 lg:pb-1 rounded-md  lg:relative lg:flex gap-x-6 mx-auto flex-col lg:flex-grow lg:flex-row">
                        ...
                        {/* <div className="mt-2 border-t lg:border-none pt-2 lg:pt-0 relative pl-3 lg:pl-0 group/country">
                            <div className="font-semibold flex align-center gap-1 hover:cursor-pointer group-hover/country:text-primary">
                                <Image
                                    src="/ind_flag.png"
                                    width={24}
                                    height={24}
                                ...
                                <ChevronDown className="transition-transform duration-300" size={18} />
                            </div>
                            <div className="lg:absolute max-h-0 group-hover/country:max-h-[300px] transition-transform nesteds overflow-hidden lg:py-1 lg:scale-0 lg:group-hover/country:scale-100 bg-card duration-300 rounded-md origin-top-left lg:shadow-lg w-fit top-6 left-[-10px] right-0 p-2 ">
                                <ul className="w-full">
                                    <li className="w-full">
                                        <div className="px-2 py-1 text-nowrap block text-sm hover:text-primary flex items-center gap-2">
                                            <Image
                                                src="/ind_flag.png"
                                                width={24}
                                                height={24}
                                                ...
                                                alt="India"
                                            />
                                            <Link href="/ind" className="hover:text-primary">
                                                INDIA
                                            </Link>
                                        </div>
                                    </li>
                                    <li className="w-full">
                                        <div className="px-2 py-1 text-nowrap block text-sm hover:text-primary flex items-center gap-2">
                                            <Image
                                                ...
                                                alt="UK"
                                            />
                                            <Link href="/uk" className="hover:text-primary">
                                                UK
                                            </Link>
                                        </div>
                                    </li>
