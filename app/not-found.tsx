        ...
        <main>
            <section className="min-h-screen grid items-center justify-center">
                <div className="align-center text-center">
                    <h3 className="text-2xl font-bold">The Page is Under Construction.</h3>
              ...
              C84.573,16.331,86.05,20.549,84.365,24.062z"
                    ...
                    <p>
                        We have launched alphalake.services and continue to build out in an
                        agile way. <br />This means some pages are still under construction.
                    </p>
                    <br />
                    <Button asChild>
